  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl text-zinc-900 mb-1">Yeni Üye Ekle</h1>
          <p className="text-zinc-500">Kütüphaneye yeni üye ekleyin</p>
        </div>
      </div>
        ...
        <div className="bg-white border border-zinc-200 rounded-xl p-6 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-2">
              Öğrenci ve öğretmen üyelikleri daha uzun ödünç alma süresine sahiptir
            </p>
          </div>
        </div>
